            ...
            <div class="px-2 flex items-center lg:px-0">
              ...
              <div class="hidden lg:block lg:ml-10">
                <div class="flex space-x-4">
                  <router-link v-for="item in navigation" :key="item.name" :to="item.href" :class="[item.current ? 'bg-indigo-700 text-white' : 'text-white hover:bg-indigo-500 hover:bg-opacity-75', 'rounded-md py-2 px-3 text-sm font-medium']" :aria-current="item.current ? 'page' : undefined">
                    {{ item.name }}
                  </router-link>
                </div>
              </div>
...
const navigation = [
  ...
  { name: 'Pagina 1', href: 'pagina-1', current: false },
  { name: 'Pagina 2', href: 'pagina-2', current: false },
  { name: 'Pagina 3', href: 'pagina-3', current: false },
  { name: 'Pagina 4', href: 'pagina-4', current: false },
]
