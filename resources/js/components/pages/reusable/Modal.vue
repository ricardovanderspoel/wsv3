    ...
    methods: {
      startPayment() {
        this.$axios.get('/sanctum/csrf-cookie').then(response => {
          this.$axios.post('/api/billing/checkout').then(response => {
            console.log(response);
            var redirect_url = response.data.url;
