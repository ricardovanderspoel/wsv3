    ...
    <div class="relative">
      <div class="inline-flex shadow-sm rounded-md divide-x divide-indigo-600">
        <div class="relative z-0 inline-flex shadow-sm rounded-md divide-x divide-indigo-600">
          ...
          <ListboxButton class="relative inline-flex items-center bg-indigo-500 p-2 rounded-l-none rounded-r-md text-sm font-medium text-white focus:outline-none">
...
const publishingOptions = [
  { title: 'My Company', description: 'This is my company.', current: true },
  { title: 'Quin her Company', description: 'This is quins company.', current: false },
]
